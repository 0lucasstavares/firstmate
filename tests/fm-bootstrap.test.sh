...
missing persona is flagged^{"rules":[{"when":"implementation","use":{"harness":"codex","persona":"missing"}}]}^grep^CREW_DISPATCH: invalid config/crew-dispatch.json - invalid persona: missing (persona missing: missing, not regular, or symlinked)
